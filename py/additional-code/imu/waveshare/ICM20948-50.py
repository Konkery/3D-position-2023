...
REG_ADD_MAG_ST1                      = 0x10
REG_ADD_MAG_ST2                      = 0x18
...
class ICM20948(object):
  def __init__(self,address=I2C_ADD_ICM20948):
    ...
    self.icm20948WriteSecondary( I2C_ADD_ICM20948_AK09916|I2C_ADD_ICM20948_AK09916_WRITE,REG_ADD_MAG_CNTL2, REG_VAL_MAG_MODE_50HZ)
  ...
  def icm20948MagRead(self):
    ...
    while(counter>0):
      time.sleep(0.01)
      self.icm20948ReadSecondary( I2C_ADD_ICM20948_AK09916|I2C_ADD_ICM20948_AK09916_READ , REG_ADD_MAG_ST1, 1)
      if ((pu8data[0] & 0x01)!= 0):
        break
      counter-=1
    if counter!=0:
  ...
  def icm20948ReadSecondary(self,u8I2CAddr,u8RegAddr,u8Len):
    ...
    self._write_byte( REG_ADD_I2C_SLV0_ADDR, u8I2CAddr)          #на чтение
    self._write_byte( REG_ADD_I2C_SLV0_REG,  u8RegAddr)          # передали адрес магнитометра
