...
class ICM20948:
    ...
    def mag_write(self, reg, value):
        ...
        self._bus.write_byte_data(AK09916_I2C_ADDR, reg, value)
        time.sleep(0.0001)
        # self.bank(3)
    ...
    def mag_read(self, reg):
        ...
        return self._bus.read_byte_data(AK09916_I2C_ADDR, reg)
        # self.bank(3)
    ...
    def mag_read_bytes(self, reg, length=1):
        ...
        return self._bus.read_i2c_block_data(AK09916_I2C_ADDR, reg, length)
    ...
    def enable_passthrough(self, passthrough):
        """ 
    ...
    def __init__(self, i2c_addr=I2C_ADDR, i2c_bus=None):
        ...
        self.bank(0)
        print(self.read(ICM20948_INT_PIN_CFG))
        self.write(ICM20948_INT_PIN_CFG, 0x30)
        time.sleep(0.05)
        self.enable_passthrough(True)
        time.sleep(0.05)
        print(self.read(ICM20948_INT_PIN_CFG))
        time.sleep(0.1)
        c = 0
