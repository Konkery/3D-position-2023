...
class ICM20948:
    ...
    def mag_read_bytes(self, reg, length=1):
        ...
        i2cAddr = AK09916_I2C_ADDR | 0x80
        self.bank(3)
        # test
        self.write(ICM20948_I2C_SLV0_ADDR, i2cAddr)
        self.write(ICM20948_I2C_SLV0_REG, reg)
        self.write(ICM20948_I2C_SLV0_CTRL, 0x80 | length)
        # /test
        # original
        ...
        # fix
        data = self.read_bytes(ICM20948_EXT_SLV_SENS_DATA_00, length)

        self.bank(3)

        temp = self.read(ICM20948_I2C_SLV0_CTRL)
        temp &= ~(0x20 & 0x07)
        self.write(ICM20948_I2C_SLV0_CTRL, temp)
    ...
    def i2cMasterEnable(self, enable):
        ...
        self.bank(3)
        register = self.read(I2C_ADDR, ICM20948_I2C_MST_CTRL)
        ...
        # Write register
        self.bank(3)
        self.write(self._addr, ICM20948_I2C_MST_CTRL, register)

        # enable/disable Master I2C
        # Read the AGB0_REG_USER_CTRL, store in local variable "register"
        self.bank(0)
        register = self.read(self._addr, ICM20948_I2C_MST_CTRL)
        ...
        # Write register
        self.bank(0)
        return self.write(self._addr, ICM20948_USER_CTRL, register)
